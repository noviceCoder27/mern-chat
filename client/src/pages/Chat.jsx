...
function Chat(props) {
  ...
  return (
    <>
      {
        activeChat ?
          <div className={`${props.className}  mx-5 ${props.displayChat ? "": "max-lg:hidden"}`}>
            <div className='flex justify-between items-center px-5 bg-[#4d426d] w-[100%] '>
              <div className='flex items-center gap-x-[10px]'>
                <div className='flex items-center gap-3'>
                  <BsArrowLeft style = {{color: "white"}} onClick={() => props.setDisplayChat(false)}/>
            ...
            <div className='scrollbar-hide w-[100%] h-[70vh] md:h-[66vh] bg-[#5c4f81] rounded-[10px] mt-10 lg:h-[69vh] flex flex-col overflow-y-scroll p-4'>
            ...
            <div className='absolute w-full bottom-[1rem] mt-2 bg-[#5c4f81] rounded-[10px]'>
              ...
              <div className='border-[1px] border-[#4d426d] px-6 py-3 h-[50px] rounded-t-[10px]'>
                ...
                <form onKeyDown={(e) => keyDownFunction(e)} onSubmit={(e) => e.preventDefault()}>
                  ...
                  }} className='focus:outline-0 w-[100%] bg-[#5c4f81] placeholder:text-white text-white' type="text" name="message" placeholder="Enter message" value={message} />
                </form>
              ...
              <div className='border-x-[1px] border-b-[1px] border-[#4d426d] px-6 py-3 rounded-b-[10px] h-[50px] '>
                <div className='flex items-start justify-between'>
                  ...
                  <button onClick={(e) => keyDownFunction(e)} className='bg-[#efaa86] px-4 text-[14px] py-[3px] font-medium rounded-xl -mt-1'>Send</button>
                </div>
              </div>
            </div>
          </div> :
          <div className={`${props.className} bg-[#5c4f81!important] ${props.displayChat ? "": "max-lg:hidden"}`}>
            <div className='relative '>
              <div className='absolute top-[40vh] left-[44%] flex flex-col items-center justify-center gap-y-3'>
                ...
                <h3 className='text-white text-[20px] font-medium tracking-wider'>Welcome <span className='text-[#efaa86] text-[19px] font-bold'> {activeUser.name}</span></h3>
              </div>
            </div>
          </div>
